...
/**
 * Sweep (usually from right to left) to sleep. This *should always* be supported by
 * the hardware directly. Many of semi-recent touch controllers have a firmware
 * option for this
 */
